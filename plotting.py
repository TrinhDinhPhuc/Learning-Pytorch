...
if __name__ == '__main__':
    ...
    # Import data
    df = pd.read_csv('Perceptron Alg//data.csv', sep=',', header=None, names=['x1', 'x2', 'y'])
    X = df[['x1', 'x2']].values
    y = df['y'].values
    ...
    ax.scatter(df.loc[50:, 'x1'], df.loc[50:, 'x2'], label='class 1', marker='x')
